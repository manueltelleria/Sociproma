<?php
/* Smarty version 3.1.30, created on 2017-03-09 00:07:11
  from "/opt/lampp/htdocs/smarty/templates/encabezado.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58c08e9f881163_80310330',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bef5f86c341a74040a036f5ee8ac7c3a05ba65c0' => 
    array (
      0 => '/opt/lampp/htdocs/smarty/templates/encabezado.tpl',
      1 => 1489012982,
      2 => 'file',
    ),
  ),
...
function content_58c08e9f881163_80310330 (Smarty_Internal_Template $_smarty_tpl) {
...
<ul class="adxm menu"> 
  <?php if ($_smarty_tpl->tpl_vars['badministra']->value) {?>
    <li><a href="javascript:void();" title="Administración del Sistema">Administración</a>
      <ul> 
        <li><a href="http://localhost/sociproma/CtrlUsuario.php" title="Registro de Usuarios">Usuarios</a></li> 
        <li><a href="http://localhost/sociproma/CtrlDoctor.php" title="Registro de Doctores">Doctores</a></li> 
        <li><a href="http://localhost/sociproma/CtrlPaciente.php" title="Registro de Pacientes">Pacientes</a></li> 
        <li><a href="http://localhost/sociproma/CtrlResponsable.php" title="Registro de Responsables">Responsables</a></li> 
        <li><a href="http://localhost/sociproma/CtrlIntervencion.php" title="Registro de Tipo de Intervenciones">Tipo de Intervenciones</a></li> 
      </ul> 
    </li> 
  <?php }?>
  <li><a href="javascript:void()" title="Recibos">Recibos</a>
    <ul> 
      <li><div><a href="http://localhost/sociproma/CtrlPacienteIntervencion.php" title="Cargar Recibo" >Cargar Recibo</a></div></li> 
      <li><div><a href="http://localhost/sociproma/CtrlPagarRecibo.php" title="Pagar Recibo" >Pagar Recibo</a></div></li> 
    </ul> 
  </li> 
  <li><a href="javascript:void();" title="Consultas del Sistema">Consultas</a>
    <ul> 
      <li><div><a href="http://localhost/sociproma/CtrlBuscarRecibo.php" title="Consulta de Recibos" >Consulta Recibos</a></div></li> 
    </ul> 
  </li> 
  <li><a href="http://localhost/sociproma/Salir.php" title="Salir del Sistema">Salir</a></li> 
</ul> 
</div>  
