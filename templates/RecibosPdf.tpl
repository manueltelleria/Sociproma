...
<TABLE width="100%" align="right" celspacing="0" celpaddign="1" border="0">
  <tr>
    <td width="100%" align="right">{$nombre_log}&nbsp;{$smarty.now|date_format:"%d/%m/%Y %H:%M:%S"}</td>
  </tr>
</table>
</page_header>
<page_footer>
...
<td align="right" style="text-align: right;width: 30%;">P&aacute;gina [[page_cu]]/[[page_nb]]</td>
</tr>
</table>
</page_footer>
