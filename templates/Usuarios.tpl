...
<table width="75%" cellpadding="1" align="center">
  ...
  {foreach from=$ArrUsuarios key=Id item=field}
    <tr class={$field.clase}>
      ...
      <td align="center"><a href="javascript:if (confirm('Desea eliminar el registro'))runMode( 'elimina', {$field.id} );"><img src="/imagenes/b_drop.png"></a></td>
    </tr>
  {/foreach}
</table>
