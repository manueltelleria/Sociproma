...
<table width="75%" cellpadding="1" align="center">
  ...
  {foreach from=$ArrIntervenciones key=Id item=field}
    <tr class={$field.clase}>
      ...
      <td align="center"><a href="#" onclick="runMode( 'actualiza', {$field.id} );"><img width="15xp" heith="15xp" src="/imagenes/bad.png"></a></td>
      <td align="center"><a href="javascript:if (confirm('Desea eliminar el registro'))runMode( 'elimina', {$field.id} );"><img src="/imagenes/del.png"></a></td>
    </tr>
  {/foreach}
</table>
